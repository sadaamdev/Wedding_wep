...
import { graduationPackages } from '@/lib/data'
    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="relative py-32 lg:py-40 bg-primary overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.pexels.com/photos/1438072/pexels-photo-1438072.jpeg?w=1920&h=600&fit=crop')`,
          }}
        />
        ...
        <div className="relative z-10 container-custom px-4">
          ...
          >
            ...
            <p className="font-body text-lg text-white/70 max-w-2xl mx-auto">
              Celebrate your academic achievement with a memorable graduation ceremony.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <div className="p-8 flex flex-col flex-1 h-full">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      {index === 0 && <GraduationCap className={cn("w-5 h-5", pkg.featured ? "text-gold" : "text-rose-400")} />}
                      {index === 1 && <Sparkles className={cn("w-5 h-5", pkg.featured ? "text-gold" : "text-gold")} />}
                      {index === 2 && <Star className="w-5 h-5 text-gold" />}
                      {index === 3 && <GraduationCap className={cn("w-5 h-5", pkg.featured ? "text-gold" : "text-indigo-500")} />}
