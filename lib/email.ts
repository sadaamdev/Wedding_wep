...
export async function sendContactEmail(data: {
  ...
  return resend.emails.send({
    from: 'XULASHO <onboarding@resend.dev>',
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #f5f5f5; padding: 20px; border-radius: 8px;">
          ...
          <p><strong>Event Type:</strong> ${packageNames[data.eventType] || data.eventType}</p>
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Dear ${data.name},</p>
        <p>We have received your booking request for a ${packageNames[data.eventType] || data.eventType}. Our team will contact you within 24 hours to discuss your event details.</p>
